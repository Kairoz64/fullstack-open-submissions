describe('Blog app', function () {
  ...
  describe('Login', function () {
    it('succeeds with correct credentials', function () {
      cy.get('#username-login').type('cat0');
      cy.get('#password-login').type('meow');
    ...
    it('fails with wrong credentials', function () {
      cy.get('#username-login').type('cat0');
      cy.get('#password-login').type('kek');
      cy.get('#submit-login').click();
  ...
  describe('when logged in', function () {
    ...
    it('A blog can be created', function () {
      ...
      cy.get('#title-newBlog').type('Wakanko');
      cy.get('#author-newBlog').type('Fast Cat');
      cy.get('#url-newBlog').type('example.com');
    ...
    describe('and some blogs exist', function () {
      ...
      describe('blogs have likes', function () {
        beforeEach(function () {
          ...
          cy.contains('blog4').contains('view').click();
          cy.wait(150);
